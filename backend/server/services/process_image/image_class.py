...
def predict_class(pil_img: Image.Image):
    ...
    return decode_predictions(preds, top=1)[0] # Best prediction

# Replace this with your own PIL image
pil_img = Image.open('random.jpg')  # Example PIL image

prediction = predict_class(pil_img)

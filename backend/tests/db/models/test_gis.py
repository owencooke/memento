...
class TestCoordinates:
    ...
    def test_from_geojson_invalid(self) -> None:
    ...
    def test_from_postgis_binary_valid(self, postgis_hex: str) -> None:
    ...
    def test_from_postgis_binary_invalid(self) -> None:
        """Test from_postgis_binary method with invalid hex string."""
        with patch(
            "binascii.unhexlify",
            side_effect=binascii.Error("Invalid hex"),
        ) and pytest.raises(ValueError, match="Invalid Postgis binary format"):
...
class TestBaseWithCoordinates:
    ...
    def test_init_with_coordinates_object(
        self,
        coordinates_data: dict[str, float],
    ) -> None:
    ...
    def test_init_with_postgis_binary(self, postgis_hex: str) -> None:
    ...
    def test_init_with_dict(self, coordinates_data: dict[str, float]) -> None:
    ...
    def test_init_with_geojson(self, geojson_point: dict[str, Any]) -> None:
...
class TestCoordinatesInsert:
    ...
    def test_model_dump_with_coordinates(
        self,
        coordinates_data: dict[str, float],
    ) -> None:
    ...
    def test_model_dump_without_coordinates(self) -> None:
    ...
    def test_model_dump_with_non_coordinates_object(self) -> None:

...
class TestImageProcessor:
    ...
    def test_prepare_image_success(self, mock_pil_image: MagicMock) -> None:
    ...
    def test_prepare_image_exception(self, mock_pil_image: MagicMock) -> None:
    ...
    def test_prepare_image_rounded_corners(self, mock_pil_image: MagicMock) -> None:
    ...
    def test_rotate_image_success(self, mock_pil_image: MagicMock) -> None:
    ...
    def test_rotate_image_convert_to_rgba(self, mock_pil_image: MagicMock) -> None:
    ...
    def test_rotate_image_exception(self, mock_pil_image: MagicMock) -> None:

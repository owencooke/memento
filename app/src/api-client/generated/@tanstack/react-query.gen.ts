...
export const userInfoApiUserPostQueryKey = (
  options: Options<UserInfoApiUserPostData>,
) => createQueryKey("userInfoApiUserPost", options);

export const userInfoApiUserPostOptions = (
  options: Options<UserInfoApiUserPostData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const userInfoApiUserPostMutation = (
  options?: Partial<Options<UserInfoApiUserPostData>>,
) => {
  const mutationOptions: UseMutationOptions<
    UserInfoApiUserPostResponse,
    UserInfoApiUserPostError,
    Options<UserInfoApiUserPostData>
  > = {

...
export const deleteMementoApiUserUserIdMementoIdDeleteMutation = (options?: Partial<Options<DeleteMementoApiUserUserIdMementoIdDeleteData>>) => {
    const mutationOptions: UseMutationOptions<DeleteMementoApiUserUserIdMementoIdDeleteResponse, DeleteMementoApiUserUserIdMementoIdDeleteError, Options<DeleteMementoApiUserUserIdMementoIdDeleteData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteMementoApiUserUserIdMementoIdDelete({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const testRecommendCollectionApiTestingRecommendCollectionUserIdPostQueryKey = (options: Options<TestRecommendCollectionApiTestingRecommendCollectionUserIdPostData>) => createQueryKey('testRecommendCollectionApiTestingRecommendCollectionUserIdPost', options);

export const testRecommendCollectionApiTestingRecommendCollectionUserIdPostOptions = (options: Options<TestRecommendCollectionApiTestingRecommendCollectionUserIdPostData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await testRecommendCollectionApiTestingRecommendCollectionUserIdPost({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: testRecommendCollectionApiTestingRecommendCollectionUserIdPostQueryKey(options)
    });
};

export const testRecommendCollectionApiTestingRecommendCollectionUserIdPostMutation = (options?: Partial<Options<TestRecommendCollectionApiTestingRecommendCollectionUserIdPostData>>) => {
    const mutationOptions: UseMutationOptions<TestRecommendCollectionApiTestingRecommendCollectionUserIdPostResponse, TestRecommendCollectionApiTestingRecommendCollectionUserIdPostError, Options<TestRecommendCollectionApiTestingRecommendCollectionUserIdPostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await testRecommendCollectionApiTestingRecommendCollectionUserIdPost({
                ...options,
                ...localOptions,

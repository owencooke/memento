...
export const generateCollageApiUserUserIdCollectionIdCollagePostQueryKey = (options: Options<GenerateCollageApiUserUserIdCollectionIdCollagePostData>) => createQueryKey('generateCollageApiUserUserIdCollectionIdCollagePost', options);

export const generateCollageApiUserUserIdCollectionIdCollagePostOptions = (options: Options<GenerateCollageApiUserUserIdCollectionIdCollagePostData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await generateCollageApiUserUserIdCollectionIdCollagePost({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: generateCollageApiUserUserIdCollectionIdCollagePostQueryKey(options)
    });
};

export const generateCollageApiUserUserIdCollectionIdCollagePostMutation = (options?: Partial<Options<GenerateCollageApiUserUserIdCollectionIdCollagePostData>>) => {
    const mutationOptions: UseMutationOptions<unknown, GenerateCollageApiUserUserIdCollectionIdCollagePostError, Options<GenerateCollageApiUserUserIdCollectionIdCollagePostData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await generateCollageApiUserUserIdCollectionIdCollagePost({
                ...options,
                ...localOptions,

...
import {
  ...
  classifyImageApiImageClassifyPost,
...
export const postUserInfoApiUserPostQueryKey = (
  options: Options<PostUserInfoApiUserPostData>,
) => createQueryKey("postUserInfoApiUserPost", options);

export const postUserInfoApiUserPostOptions = (
  options: Options<PostUserInfoApiUserPostData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const postUserInfoApiUserPostMutation = (
  options?: Partial<Options<PostUserInfoApiUserPostData>>,
) => {
  const mutationOptions: UseMutationOptions<
    PostUserInfoApiUserPostResponse,
    PostUserInfoApiUserPostError,
    Options<PostUserInfoApiUserPostData>
  > = {
...
export const extractTextApiImageExtractTextPostQueryKey = (
  options: Options<ExtractTextApiImageExtractTextPostData>,
) => createQueryKey("extractTextApiImageExtractTextPost", options);

export const extractTextApiImageExtractTextPostOptions = (
  options: Options<ExtractTextApiImageExtractTextPostData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const extractTextApiImageExtractTextPostMutation = (
  options?: Partial<Options<ExtractTextApiImageExtractTextPostData>>,
) => {
  const mutationOptions: UseMutationOptions<
    ExtractTextApiImageExtractTextPostResponse,
    ExtractTextApiImageExtractTextPostError,
    Options<ExtractTextApiImageExtractTextPostData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await extractTextApiImageExtractTextPost({
        ...options,
...
export const classifyImageApiImageClassifyPostQueryKey = (
  options: Options<ClassifyImageApiImageClassifyPostData>,
) => createQueryKey("classifyImageApiImageClassifyPost", options);

export const classifyImageApiImageClassifyPostOptions = (
  options: Options<ClassifyImageApiImageClassifyPostData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const classifyImageApiImageClassifyPostMutation = (
  options?: Partial<Options<ClassifyImageApiImageClassifyPostData>>,
) => {
  const mutationOptions: UseMutationOptions<
    ClassifyImageApiImageClassifyPostResponse,
    ClassifyImageApiImageClassifyPostError,
    Options<ClassifyImageApiImageClassifyPostData>
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await classifyImageApiImageClassifyPost({
        ...options,

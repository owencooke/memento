 ...
 */
export const userInfoApiUserPost = <ThrowOnError extends boolean = false>(options: Options<UserInfoApiUserPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UserInfoApiUserPostResponse, UserInfoApiUserPostError, ThrowOnError>({
        url: '/api/user/',
        ...options,
        headers: {

 ...
 */
export const generateCollageApiUserUserIdCollectionIdCollagePost = <ThrowOnError extends boolean = false>(options: Options<GenerateCollageApiUserUserIdCollectionIdCollagePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, GenerateCollageApiUserUserIdCollectionIdCollagePostError, ThrowOnError>({

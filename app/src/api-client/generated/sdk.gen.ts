...
import type {
  ...
  UserInfoApiUserIdGetResponse,
  UserInfoApiUserIdGetError,
  PostUserInfoApiUserPostData,
  PostUserInfoApiUserPostResponse,
  PostUserInfoApiUserPostError,
  RemoveImageBackgroundApiImageRemoveBackgroundPostData,
  RemoveImageBackgroundApiImageRemoveBackgroundPostError,
  ExtractTextApiImageExtractTextPostData,
  ExtractTextApiImageExtractTextPostResponse,
  ExtractTextApiImageExtractTextPostError,
  ClassifyImageApiImageClassifyPostData,
  ClassifyImageApiImageClassifyPostResponse,
  ClassifyImageApiImageClassifyPostError,
  GetUsersMementosApiUserUserIdMementoGetData,
  GetUsersMementosApiUserUserIdMementoGetResponse,
  GetUsersMementosApiUserUserIdMementoGetError,
  ...
  GetUsersCollectionsApiUserUserIdCollectionGetResponse,
  GetUsersCollectionsApiUserUserIdCollectionGetError,
  ...
  GenerateCollageApiUserUserIdCollectionIdCollageGetData,
  GenerateCollageApiUserUserIdCollectionIdCollageGetError,
  TestCollageApiTestingCollageGetData,
  TestCollageApiTestingCollageGetError,
} from "./types.gen";
 ...
 */
export const healthCheckApiGet = <ThrowOnError extends boolean = false>(
  options?: Options<HealthCheckApiGetData, ThrowOnError>,
) => {
 ...
 */
export const userInfoApiUserIdGet = <ThrowOnError extends boolean = false>(
  options: Options<UserInfoApiUserIdGetData, ThrowOnError>,
) => {
 ...
 */
export const postUserInfoApiUserPost = <ThrowOnError extends boolean = false>(
  options: Options<PostUserInfoApiUserPostData, ThrowOnError>,
) => {
 ...
 */
export const removeImageBackgroundApiImageRemoveBackgroundPost = <
 ...
 */
export const extractTextApiImageExtractTextPost = <
  ThrowOnError extends boolean = false,
>(
  options: Options<ExtractTextApiImageExtractTextPostData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    ExtractTextApiImageExtractTextPostResponse,
    ExtractTextApiImageExtractTextPostError,
 ...
 */
export const classifyImageApiImageClassifyPost = <
  ThrowOnError extends boolean = false,
>(
  options: Options<ClassifyImageApiImageClassifyPostData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    ClassifyImageApiImageClassifyPostResponse,
    ClassifyImageApiImageClassifyPostError,
 ...
 */
export const getUsersMementosApiUserUserIdMementoGet = <
  ThrowOnError extends boolean = false,
>(
  options: Options<GetUsersMementosApiUserUserIdMementoGetData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetUsersMementosApiUserUserIdMementoGetResponse,
    GetUsersMementosApiUserUserIdMementoGetError,
 ...
 */
export const createNewMementoApiUserUserIdMementoPost = <
  ThrowOnError extends boolean = false,
>(
  options: Options<CreateNewMementoApiUserUserIdMementoPostData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    CreateNewMementoApiUserUserIdMementoPostResponse,
    CreateNewMementoApiUserUserIdMementoPostError,
 ...
 * Uses multipart/form-data to upload JSON/binary payloads simultaneously.
 */
export const updateMementoAndImagesApiUserUserIdMementoIdPut = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    UpdateMementoAndImagesApiUserUserIdMementoIdPutData,
 ...
 */
export const getUsersCollectionsApiUserUserIdCollectionGet = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    GetUsersCollectionsApiUserUserIdCollectionGetData,
 ...
 * Create a collection.
 */
export const createNewCollectionApiUserUserIdCollectionPost = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    CreateNewCollectionApiUserUserIdCollectionPostData,
 ...
 * Delete a collection.
 */
export const deleteCollectionApiUserUserIdCollectionIdDelete = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    DeleteCollectionApiUserUserIdCollectionIdDeleteData,
 ...
 * Update a collection.
 */
export const updateCollectionAndMementosApiUserUserIdCollectionIdPut = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    UpdateCollectionAndMementosApiUserUserIdCollectionIdPutData,
 ...
 */
export const generateCollageApiUserUserIdCollectionIdCollageGet = <
  ThrowOnError extends boolean = false,
>(
  options: Options<
    GenerateCollageApiUserUserIdCollectionIdCollageGetData,
 ...
 */
export const testCollageApiTestingCollageGet = <
  ThrowOnError extends boolean = false,
>(
  options: Options<TestCollageApiTestingCollageGetData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    unknown,
    TestCollageApiTestingCollageGetError,

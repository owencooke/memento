 ...
 * Delete a memento
 */
export const deleteMementoApiUserUserIdMementoIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteMementoApiUserUserIdMementoIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteMementoApiUserUserIdMementoIdDeleteResponse, DeleteMementoApiUserUserIdMementoIdDeleteError, ThrowOnError>({
...
/**
 * Test Recommend Collection
 * Test endpoint for recommending a collection via WS.
 */
export const testRecommendCollectionApiTestingRecommendCollectionUserIdPost = <ThrowOnError extends boolean = false>(options: Options<TestRecommendCollectionApiTestingRecommendCollectionUserIdPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TestRecommendCollectionApiTestingRecommendCollectionUserIdPostResponse, TestRecommendCollectionApiTestingRecommendCollectionUserIdPostError, ThrowOnError>({

...
export const colors = {
  light: {
    ...
    "--color-primary-500": "61 154 226", // Brand color #3d9ae2
    ...
    /* Secondary - Based on #809be7 (Blue Cue) - Lightened for better button contrast */
    "--color-secondary-0": "241 245 254",
    "--color-secondary-50": "235 241 252",
    "--color-secondary-100": "224 233 250",
    "--color-secondary-200": "198 213 246",
    "--color-secondary-300": "165 187 240",
    "--color-secondary-400": "141 168 235",
    "--color-secondary-500": "128 155 231", // Brand color #809be7
    "--color-secondary-600": "102 124 185",
    "--color-secondary-700": "85 103 154",
    "--color-secondary-800": "68 83 123",
    "--color-secondary-900": "51 62 92",
    "--color-secondary-950": "34 41 62",

    /* Tertiary - Based on #36454f (Azul Petróleo) - Moved from secondary */
    "--color-tertiary-0": "230 235 240",
    "--color-tertiary-50": "218 224 230",
    "--color-tertiary-100": "202 210 217",
    "--color-tertiary-200": "179 188 196",
    "--color-tertiary-300": "147 159 171",
    "--color-tertiary-400": "103 115 127",
    "--color-tertiary-500": "54 69 79", // Brand color #36454f
    "--color-tertiary-600": "43 55 63",
    "--color-tertiary-700": "36 46 53",
    "--color-tertiary-800": "29 37 42",
    "--color-tertiary-900": "21 27 31",
    "--color-tertiary-950": "14 18 21",
    ...
    "--color-info-200": "189 219 255", // Brand color #bddbff
    ...
    /* Typography - Improved for button contrast */
    ...
    "--color-typography-700": "54 69 79", // Uses Azul Petróleo
    "--color-typography-800": "43 55 63",
    "--color-typography-900": "29 37 42",
    "--color-typography-950": "14 18 21",

    /* Typography for Primary Buttons */
    "--color-typography-primary-button": "255 255 255", // White for dark backgrounds

    /* Typography for Secondary Buttons */
    "--color-typography-secondary-button": "54 69 79", // Dark color (from Azul Petróleo) for light backgrounds
    ...
    "--color-background-200": "230 235 240", // Hint of Azul Petróleo
    ...
    "--color-background-800": "54 69 79", // Uses Azul Petróleo
    ...
    "--color-background-info": "245 251 255", // Hint of Dithered Sky

    /* Focus Ring Indicator */
    "--color-indicator-primary": "61 154 226", // Flax Flower Blue
    "--color-indicator-info": "189 219 255", // Dithered Sky
  ...
  dark: {
    ...
    "--color-primary-400": "61 154 226", // Brand color #3d9ae2
    ...
    /* Secondary - Based on #809be7 (Blue Cue) */
    "--color-secondary-0": "34 41 62",
    "--color-secondary-50": "51 62 92",
    "--color-secondary-100": "68 83 123",
    "--color-secondary-200": "85 103 154",
    "--color-secondary-300": "102 124 185",
    "--color-secondary-400": "128 155 231", // Brand color #809be7
    "--color-secondary-500": "141 168 235",
    "--color-secondary-600": "165 187 240",
    "--color-secondary-700": "198 213 246",
    "--color-secondary-800": "224 233 250",
    "--color-secondary-900": "235 241 252",
    "--color-secondary-950": "241 245 254",

    /* Tertiary - Based on #36454f (Azul Petróleo) */
    "--color-tertiary-0": "14 18 21",
    "--color-tertiary-50": "21 27 31",
    "--color-tertiary-100": "29 37 42",
    "--color-tertiary-200": "36 46 53",
    "--color-tertiary-300": "43 55 63",
    "--color-tertiary-400": "54 69 79", // Brand color #36454f
    "--color-tertiary-500": "103 115 127",
    "--color-tertiary-600": "147 159 171",
    "--color-tertiary-700": "179 188 196",
    "--color-tertiary-800": "202 210 217",
    "--color-tertiary-900": "218 224 230",
    "--color-tertiary-950": "230 235 240",
    ...
    /* Typography for Primary Buttons */
    "--color-typography-primary-button": "18 44 64", // Dark color for light backgrounds

    /* Typography for Secondary Buttons */
    "--color-typography-secondary-button": "255 255 255", // White for dark backgrounds

    /* Outline */
    "--color-outline-0": "14 18 21",
    "--color-outline-50": "29 37 42",
    "--color-outline-100": "43 55 63",
    "--color-outline-200": "54 69 79", // Uses Azul Petróleo
    ...
    /* Background */
    "--color-background-0": "21 27 31", // Darker version of Azul Petróleo
    "--color-background-50": "29 37 42",
    "--color-background-100": "36 46 53",
    "--color-background-200": "43 55 63",
    "--color-background-300": "54 69 79", // Uses Azul Petróleo
    ...
    "--color-background-900": "230 235 240", // Hint of Azul Petróleo
    ...
    "--color-background-muted": "43 55 63", // Darker version of Azul Petróleo
    "--color-background-info": "29 53 74", // Darker version of Flax Flower Blue

    /* Focus Ring Indicator */
    "--color-indicator-primary": "110 177 242", // Lighter Flax Flower Blue
    "--color-indicator-info": "189 219 255", // Dithered Sky
